...
Original file is located at
    https://colab.research.google.com/drive/1-LBNA8o-U1oOlXGadtuRzIeFQO1j4oa6

We will train an attention seq2seq for translating from French to English, using the Pytorch tutorial: https://pytorch.org/tutorials/intermediate/seq2seq_translation_tutorial.html
"""
...
def readLangs(lang1, lang2, reverse=False):
    ...
    lang_df = pd.read_csv("corpus/parallel_nh-es.csv", delimiter="|")
    # print(lang_df.head())
    # print(lang_df.columns.to_list())
    pairs = lang_df[['Nahuatl', 'Spanish']].to_numpy()
    # Normalizes words
...
input_lang, output_lang, pairs = prepareData('nh', 'es', True)
...
evaluate_bleu(encoder1, attn_decoder1)
